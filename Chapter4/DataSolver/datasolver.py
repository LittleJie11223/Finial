...
def get_deleteList():
    ...
    list1 = [
        ...
        851, 853, 856, 857, 858, 861, 863, 868, 869, 870, 874, 877, 879, 882, 888, 889, 901, 907, 908, 909, 911, 914,
        915, 919,
        ...
        1057, 1058, 1059, 1063, 1066, 1068, 1069, 1074, 1077, 1079, 1081, 1084, 1087, 1088, 1089, 1093, 1094, 1096,
        1097, 1098, 1099,
        ...
        1280, 1281, 1283, 1284, 1285, 1288, 1289, 1290, 1291, 1292, 1294, 1296, 1298, 1299, 1300, 1301, 1305, 1307,
        1308, 1309,
        1310, 1311, 1314, 1317, 1319, 1320, 1321, 1323, 1326, 1327, 1329, 1330, 1331, 1335, 1337, 1340, 1341, 1343,
        1344, 1345, 1346, 1347, 1349,
        1351, 1353, 1354, 1357, 1359, 1361, 1362, 1363, 1364, 1365, 1366, 1367, 1368, 1370, 1371, 1372, 1373, 1374,
        1376,
        1380, 1381, 1382, 1383, 1388, 1389, 1390, 1391, 1392, 1394, 1396, 1400, 1401, 1402, 1403, 1410, 1411, 1412,
        1414, 1417, 1418,
        1420, 1421, 1427, 1428, 1430, 1431, 1432, 1433, 1437, 1438, 1439, 1440, 1442, 1444, 1447, 1449, 1450, 1452,
        1454, 1455,
        1460, 1461, 1465, 1467, 1469, 1471, 1473, 1477, 1479, 1481, 1482, 1485, 1486, 1487, 1489, 1491, 1492, 1496,
        1497, 1498, 1499,
        ...
        1604, 1605, 1607, 1608, 1609, 1610, 1611, 1612, 1619, 1620, 1621, 1623, 1626, 1631, 1633, 1634, 1636, 1637,
        1639,
        ...
        1763, 1764, 1765, 1767, 1768, 1769, 1770, 1772, 1774, 1776, 1777, 1780, 1782, 1784, 1788, 1791, 1794, 1797,
        1798,
        1808, 1809, 1811, 1812, 1813, 1815, 1817, 1818, 1821, 1823, 1824, 1825, 1827, 1829, 1830, 1831, 1832, 1833,
        1834,
        ...
        1900, 1901, 1902, 1903, 1905, 1907, 1908, 1909, 1911, 1914, 1915, 1916, 1918, 1919, 1921, 1922, 1924, 1925,
        1926, 1927, 1928,
        1931, 1932, 1933, 1934
    ]
    list2 = [
...
def find_inputsize(list_ingredients):
    row_input=0
    column_input=0
...
def find_outputsize(list_steps):
    row_output=0
    column_output=3
    for step in list_steps:
        for i in range(3):
...
def build_input(list_ingredients,dic,row_input, column_input):
    list_train=[]
    for ingredient in list_ingredients:
        ...
        for i in range(len(ingredient)):
            list2 = []
            s=list3[i]
            list2=myencode(dic,s)
            for k in range(row_input-len(list2)):
                list2.append(0)
            A[:,i]=list2
        list_train.append(A)
    return list_train
...
def build_output(list_steps,dic):
    list_test=[]
    for step in list_steps:
        list=[]
        for i in range(3):
            list2 = []
            list2=myencode(dic,step[i])
            for num in list2:
                list.append(num)
...
dic = mydictionary(list_ingredients, list_steps)
# build the input matrix and output matrix
# Firstly, make sure the size of input and output
row_input, column_input=find_inputsize(list_ingredients)
row_output, column_output=find_outputsize(list_steps)
# build the input matrix
list_train=build_input(list_ingredients,dic,row_input, column_input)
#build the output matrix
list_test=build_output(list_steps,dic)
