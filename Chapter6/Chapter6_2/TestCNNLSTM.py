...
# model fit
history = deep_model.fit(x_train, y_train,  epochs=5, validation_split=0.1)
...
deep_model.save('/Users/dengjie/PycharmProjects/program/Chapter6/Chapter6_2/myCNNLSTM_model.h5')
