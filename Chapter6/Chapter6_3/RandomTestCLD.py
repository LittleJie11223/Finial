...
model = tf.keras.models.load_model('/Users/dengjie/PycharmProjects/program/Chapter6/Chapter6_3/myCLD_model.h5')
...
f=open('/Users/dengjie/PycharmProjects/program/Chapter6/Chapter6_3/Mixresults.txt','w')
for i in range(n):
    f.write(str(i))
    f.write('\n')
    str1=''
